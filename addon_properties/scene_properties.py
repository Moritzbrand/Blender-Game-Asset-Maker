...
SCENE_PROPERTIES = [
    ...
    BoolSceneProperty("gameready_stitch_baking_holes", "Stitch Baking Holes", "Run a post-bake hole mask and stitching pass that fills unbaked pixels inside covered UV regions", False),
