...
SCENE_PROPERTIES = [
    ...
    BoolSceneProperty(
        "gameready_use_custom_title",
        "Custom Title",
        "Use a custom title for generated assets and exported files (without renaming your source object)",
        default=False,
    ),
    StringSceneProperty(
        "gameready_custom_title",
        "Title",
        "Custom title used when 'Custom Title' is enabled",
        default="",
    ),
    ...
    BoolSceneProperty(
        ...
        "Export Model",
        "Export the generated model after processing",
        True,
    ),
    EnumSceneProperty(
    ...
    IntSceneProperty(
        "gameready_uv_island_margin",
        "UV Island Margin",
        "Final UV island margin in pixels used when packing islands",
        default=1,
        min=0,
        max=16,
    ),
    BoolSceneProperty(
        "gameready_bake_selected_to_active",
        "Bake Selected to Active",
        "Use non-active selected objects as bake source and the active object as the bake target",
        False,
    ),
    ...
    BoolSceneProperty(
        "gameready_average_triangle_density",
        "Average Out Triangle Density",
        "Decimate overly dense source-object copies before union so sparse areas keep more of their shape",
        False,
    ),
    FloatSceneProperty(
        "gameready_max_triangle_density",
        "Max Triangle Density",
        "Maximum allowed triangle density in triangles per square Blender unit of bounding-box surface area before pre-union decimation kicks in",
        default=1000.0,
        min=0.1,
        max=100000.0,
    ),
    ...
    BoolSceneProperty(
        "gameready_fast_low_quality",
        "Fast / Low-Quality",
        "Use minimum bake samples and texture compression for quick preview bakes",
        False,
        update=on_fast_low_quality_changed,
    ),
    EnumSceneProperty(
    ...
    BoolSceneProperty(
        "gameready_auto_cage_extrusion",
        "Auto Cage Extrusion",
        "Automatically calculate a safe cage extrusion distance for selected-to-active texture baking",
        True,
    ),
    FloatSceneProperty(
